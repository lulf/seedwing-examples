...
* An link:https://github.com/seedwing-io/seedwing-java-example/blob/main/.github/workflows/proxy-ci.yam[alternative workflow] that configures maven to fetch the app's dependencies through the link:https://github.com/seedwing-io/seedwing-proxy[seedwing-proxy].
